...
from pipenv.vendor.termcolors import COLOR_MAP, COLORS, DISABLE_COLORS, colored
from pipenv.vendor.vistir.compat import to_native_string
from pipenv.vendor.vistir.cursor import hide_cursor, show_cursor
from pipenv.vendor.vistir.misc import decode_for_output, to_text
...
TRANSLATION_MAP = {10004: "OK", 10008: "x"}
...
class VistirSpinner(SpinBase):
    ...
    def ok(self, text="OK", err=False):
        ...
        _text = to_text(text) if text else "OK"
...
def _create_spinner(*args: Any, **kwargs: Any) -> Union[DummySpinner, VistirSpinner]:
